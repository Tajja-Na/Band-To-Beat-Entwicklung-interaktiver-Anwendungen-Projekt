...
public class Sound {
    ...
    public Sound() {
        ...
        try {
            tracks[0] = new Track("Media/undertale_music2.mp3"); // Titelsong
            tracks[1] = new Track("Media/w2e(musik).mp3"); // level1
            tracks[2] = new Track("Media/w2e(musik,bass).mp3"); // level2
            tracks[3] = new Track("Media/w2e(musik,bass,drums).mp3"); // level3
            tracks[4] = new Track("Media/w2e(normal).mp3"); // ende
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
